...
(cat << EOF) > $MAKEFILEDIR/$DEVICE-vendor-blobs.mk
...
for FILE in `egrep -v '(^#|^$)' proprietary-files.txt`; do
  ...
  if [[ ! "$FILE" =~ ^-.* ]]; then
    ...
    echo "    $OUTDIR/proprietary/$FILE:system/$FILE$LINEEND" >> $MAKEFILEDIR/$DEVICE-vendor-blobs.mk
  fi
done
(cat << EOF) >> $MAKEFILEDIR/$DEVICE-vendor-blobs.mk
...
(cat << EOF) > $MAKEFILEDIR/$DEVICE-vendor.mk
# Copyright (C) 2015 The CyanogenMod Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
(cat << EOF) > $MAKEFILEDIR/BoardConfigVendor.mk
# Copyright (C) 2015 The CyanogenMod Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
...
(cat << EOF) > $MAKEFILEDIR/Android.mk
# Copyright (C) 2015 The CyanogenMod Project
#
# Licensed under the Apache License, Version 2.0 (the "License");
# you may not use this file except in compliance with the License.
